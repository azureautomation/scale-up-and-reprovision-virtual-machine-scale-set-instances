<#
    .DESCRIPTION
        A runbook that will scale up and reprovision the Virtual Machine Scale Set instances.
		
		NOTE: The existing instances will be deleted and a new instances will be brought online with the
			  bigger size. If you'd like to avoid this behavior, please use the other VM Scale Set vertical
